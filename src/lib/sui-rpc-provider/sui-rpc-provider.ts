import { Connection, JsonRpcProvider, getObjectType, getObjectId, getObjectFields, getObjectDisplay, getObjectVersion, DisplayFieldsResponse, ObjectContentFields } from "@mysten/sui.js";
